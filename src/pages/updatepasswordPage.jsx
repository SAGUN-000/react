...
import { updatePassword as updateUserPassword } from '../API/UserApi';
import { updatePassword as updateAdminPassword } from '../API/AdminApi';
...
function UpdatePasswordPage() {
   ...
   * /admin/profile
   */
 const isAdmin = location.pathname === '/admin/update-password';

const backPath = isAdmin
  ? '/admin/profile'
  : '/profile';

  const passwordUpdater = isAdmin
    ? updateAdminPassword
    : updateUserPassword;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
       ...
       */
      const response = await passwordUpdater(oldPass, newPass);
      ...
      // Return to the profile after 2 seconds
      setTimeout(() => {
        navigate(backPath);
      }, 2000);
                  ...
                  {showOldPass ? (
                    ...
                    >
                      ...
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth={2}
                        d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7 1.274 4.057 5.064 7 9.542 7-1.274 4.057-5.064 7-9.542 7z"
                      />
                    </svg>
                  ...
                  {showNewPass ? (
                    ...
                    >
                      ...
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth={2}
                        d="M2.458 12C3.732 7.943 7.523 5 12 5c-4.478 0-8.268 2.943-9.542 7-1.274 4.057-5.064 7-9.542 7-1.274 4.057-5.064 7-9.542-7z"
                      />
                    </svg>
                  ...
                  {showConfirmPass ? (
                    ...
                    >
                      ...
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth={2}
                        d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477-4.057-5.064-7-9.542-7z"
                      />
                    </svg>
