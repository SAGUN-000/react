                ...
                <div className='bg-white rounded-[28px] p-8 shadow-[0_18px_50px_rgba(15,23,42,0.08)] border border-slate-100'>
                    ...
                    {userDetails ? (
                        <div className='space-y-4'>
                            ...
                            <Link
                                to='/orders'
                                className='block rounded-2xl border border-slate-200 px-5 py-4 bg-slate-50 hover:bg-slate-100 transition-colors duration-200'
                            >
                                <div className='flex items-center gap-3 text-slate-900 font-semibold'>
                                    ...
                                    >
                                        <path
                                            ...
                                            d='M15 13.5V17m0 0v3.375a1.125 1.125 0 0 0 2.25 0V17m-2.25 0H12m3 0h3.75m-13.5-7.5V5.625c0-.621.504-1.125 1.125-1.125h11.25c.621 0 1.125.504 1.125 1.125V12M6 12h12M6 12v6.375c0 .621.504 1.125 1.125 1.125h4.5'
                                        />
                                    </svg>
                            ...
                            {/* Change Password */}
                            {userDetails?.authProviderType === 'GOOGLE' ? (
